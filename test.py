...
bot = telebot.TeleBot('SECRET!!!', parse_mode='html')
...
def infos(message) -> None:
    try:
        ...
        bot.send_message(message.chat.id, 'Тебя куда-то не туда занесло, вернись лучше в главное меню ☺️', reply_markup=get_main_keyboard())
